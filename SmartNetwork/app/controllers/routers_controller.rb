class RoutersController < ApplicationController
  ...
  def create
    ...
    @router.residence = Residence.last
  ...
  private
    ...
    def router_params
      params.require(:router).permit(:mac_address, :serial_number, :router_model, :name, :latitude, :longitude, :owner)
    end
end
